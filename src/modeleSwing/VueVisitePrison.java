...
public class VueVisitePrison extends JDialog{
	...
	int longueur=110;
	int largeur = 110;
  public VueVisitePrison(JFrame j, JeuReel jeuReel) {
	  super(j,"Case Visite Prison",true);
	  ...
	  if (!jeuReel.getJoueurEnCours().getEstEmprisonne()) {
	  text =  new JTextArea("Visite de la prison : vous êtes libre !\n"
			  + "Appuyez sur ok pour continuer.", 200, 150);
	  }else {
		  text =new JTextArea("Vous êtes emprisonné.\n"
				  + "Appuyez sur ok pour continuer.", 200, 150);
	  }
	  ...
	  ImageIcon icone = VueMonopoly.traitementImg("visitePrison.jpg", label);//new ImageIcon("chance.jpg");
	  label.setIcon(icone);
