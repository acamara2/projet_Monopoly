...
public class VueEau extends JDialog {
  ...
  public VueEau(JFrame j, JeuReel jeu) {
	  super(j,"Case Eau",true);
	  this.jeu= jeu;
	  ...
	  ImageIcon icone = VueMonopoly.traitementImg("eau.jpg", label);//new ImageIcon("chance.jpg");
	  label.setIcon(icone);
